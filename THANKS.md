...
Mothership's architecture draws inspiration from the following open-source projects. Each has influenced specific design decisions, patterns, or implementation approaches. We stand on their shoulders.
